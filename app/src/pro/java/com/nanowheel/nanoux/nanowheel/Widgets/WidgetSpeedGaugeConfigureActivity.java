...
/**
 * The configuration screen for the {@link WidgetSpeedGauge WidgetBatteryBar} AppWidget.
 */
public class WidgetSpeedGaugeConfigureActivity extends Activity {

    private static final String PREFS_NAME = "WidgetSpeedGauge";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = WidgetSpeedGaugeConfigureActivity.this;
            ...
            WidgetSpeedGauge.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public WidgetSpeedGaugeConfigureActivity() {
        super();
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.widget_speed_gauge_configure);
    ...
    static void setTextColor(int which, View v){
        WidgetSpeedGaugeConfigureActivity.textC = which;
        TextView hi = v.getRootView().findViewById(R.id.speedTextW);
        hi.setTextColor(colors[which]);
        TextView hi2 = v.getRootView().findViewById(R.id.speedUnitTextW);
    ...
    static void setBackColor(int which, View v){
        WidgetSpeedGaugeConfigureActivity.backC = which;
        ImageView hi = v.getRootView().findViewById(R.id.speedGaugeBackW);
