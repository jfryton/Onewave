...
/**
 * The configuration screen for the {@link WidgetRangeGauge WidgetRangeGauge} AppWidget.
 */
public class WidgetRangeGaugeConfigureActivity extends Activity {

    private static final String PREFS_NAME = "WidgetRangeGauge";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = WidgetRangeGaugeConfigureActivity.this;
            ...
            WidgetRangeGauge.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public WidgetRangeGaugeConfigureActivity() {
        super();
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.widget_range_gauge_configure);
    ...
    static void setTextColor(int which, View v){
        WidgetRangeGaugeConfigureActivity.textC = which;
        TextView hi = v.getRootView().findViewById(R.id.rangeTextW);
        hi.setTextColor(colors[which]);
        TextView hi2 = v.getRootView().findViewById(R.id.rangeUnitTextW);
    ...
    static void setBackColor(int which, View v){
        WidgetRangeGaugeConfigureActivity.backC = which;
        ImageView hi = v.getRootView().findViewById(R.id.rangeGaugeBackW);
