...
public class FragmentDiagnoticsBindingImpl extends FragmentDiagnoticsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.speed_record, 20);
        sViewsWithIds.put(R.id.distance_record, 21);
        sViewsWithIds.put(R.id.distance_total, 22);
        sViewsWithIds.put(R.id.pitch, 23);
        sViewsWithIds.put(R.id.pitch_text, 24);
        sViewsWithIds.put(R.id.roll, 25);
        sViewsWithIds.put(R.id.roll_text, 26);
        sViewsWithIds.put(R.id.refresh_button, 27);
    }
    // views
    @NonNull
    ...
    public void setOwdevice(@Nullable com.nanowheel.nanoux.nanowheel.model.OWDevice Owdevice) {
        updateRegistration(15, Owdevice);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7ffffL) != 0) {
            ...
            if ((dirtyFlags & 0x48100L) != 0) {
                    ...
                    updateRegistration(8, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicStatusErrorValue);
            ...
            if ((dirtyFlags & 0x4a000L) != 0) {
                    ...
                    updateRegistration(13, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicBatteryTempValue);
            ...
            if ((dirtyFlags & 0x48200L) != 0) {
                    ...
                    updateRegistration(9, owdeviceCharacteristicsGetOwdeviceMockOnewheelCharacteristicPad1Value);
            ...
            if ((dirtyFlags & 0x48040L) != 0) {
                    ...
                    updateRegistration(6, owdeviceCharacteristicsGetOwdeviceMockOnewheelCharacteristicSpeedValue);
            ...
            if ((dirtyFlags & 0x48400L) != 0) {
                    ...
                    updateRegistration(10, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicTripTotalAmpHoursValue);
            ...
            if ((dirtyFlags & 0x49000L) != 0) {
                    ...
                    updateRegistration(12, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicTemperatureValue);
            ...
            if ((dirtyFlags & 0x48080L) != 0) {
                    ...
                    updateRegistration(7, owdeviceCharacteristicsGetOwdeviceMockOnewheelCharacteristicMotorTempValue);
            ...
            if ((dirtyFlags & 0x58000L) != 0) {
                    ...
                    updateRegistration(16, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicFirmwareRevisionValue);
            ...
            if ((dirtyFlags & 0x4c000L) != 0) {
                    ...
                    updateRegistration(14, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicHardwareRevisionValue);
            ...
            if ((dirtyFlags & 0x48004L) != 0) {
                    ...
                    updateRegistration(2, owdeviceCharacteristicsGetOwdeviceMockOnewheelCharacteristicOdometerValue);
            ...
            if ((dirtyFlags & 0x48018L) != 0) {
                    ...
                    updateRegistration(3, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicBatteryVoltageValue);
            ...
            if ((dirtyFlags & 0x48800L) != 0) {
                    ...
                    updateRegistration(11, owdeviceCharacteristicsGetOwdeviceMockOnewheelCharacteristicPad2Value);
            ...
            if ((dirtyFlags & 0x48002L) != 0) {
                    ...
                    updateRegistration(1, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicSpeedRpmValue);
            ...
            if ((dirtyFlags & 0x68000L) != 0) {
                    ...
                    updateRegistration(17, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicTripRegenAmpHoursValue);
            ...
            if ((dirtyFlags & 0x48020L) != 0) {
                    ...
                    updateRegistration(5, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicBatteryRemainingValue);
            ...
            if ((dirtyFlags & 0x48010L) != 0) {
                    ...
                    updateRegistration(4, owdeviceCharacteristicsGetOwdeviceOnewheelCharacteristicCurrentAmpsValue);
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicSpeedRpm).value
        flag 2 (0x3L): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicOdometer).value
        flag 3 (0x4L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value
        flag 4 (0x5L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value
        flag 5 (0x6L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryRemaining).value
        flag 6 (0x7L): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicSpeed).value
        flag 7 (0x8L): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicMotorTemp).value
        flag 8 (0x9L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicStatusError).value
        flag 9 (0xaL): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicPad1).value
        flag 10 (0xbL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicTripTotalAmpHours).value
        flag 11 (0xcL): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicPad2).value
        flag 12 (0xdL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicTemperature).value
        flag 13 (0xeL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryTemp).value
        flag 14 (0xfL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicHardwareRevision).value
        flag 15 (0x10L): owdevice
        flag 16 (0x11L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicFirmwareRevision).value
        flag 17 (0x12L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicTripRegenAmpHours).value
        flag 18 (0x13L): null
        ...
        flag 21 (0x16L): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicPad1).value.get() == "true" ? View.VISIBLE : View.INVISIBLE
        flag 22 (0x17L): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicPad1).value.get() == "true" ? View.VISIBLE : View.INVISIBLE
        flag 23 (0x18L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value.get() == null ? true : owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value.get() == null
        flag 24 (0x19L): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value.get() == null ? true : owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value.get() == null
        flag 25 (0x1aL): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicPad2).value.get() == "true" ? View.VISIBLE : View.INVISIBLE
        flag 26 (0x1bL): owdevice.characteristics.get(OWDevice.MockOnewheelCharacteristicPad2).value.get() == "true" ? View.VISIBLE : View.INVISIBLE
        flag 27 (0x1cL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicStatusError).value.get() == "true" ? View.VISIBLE : View.INVISIBLE
        flag 28 (0x1dL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicStatusError).value.get() == "true" ? View.VISIBLE : View.INVISIBLE
        flag 29 (0x1eL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value.get() == null ? true : owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value.get() == null ? " " : String.format("%3.4s", (Float.parseFloat(owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value.get())) * (Float.parseFloat(owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value.get())))
        flag 30 (0x1fL): owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value.get() == null ? true : owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value.get() == null ? " " : String.format("%3.4s", (Float.parseFloat(owdevice.characteristics.get(OWDevice.OnewheelCharacteristicBatteryVoltage).value.get())) * (Float.parseFloat(owdevice.characteristics.get(OWDevice.OnewheelCharacteristicCurrentAmps).value.get())))
    flag mapping end*/
    //end
}